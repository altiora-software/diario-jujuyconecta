  ...
  return (
    <div className="min-h-screen bg-[#020817]">
      ...
      <main className="container mx-auto px-4 py-8 lg:py-12">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-12">
          ...
          <article className="xl:col-span-8">
            ...
            {/* <Link
              href="/"
              className="inline-flex items-center gap-2 text-primary font-bold text-sm mb-8 hover:opacity-80 transition-opacity uppercase tracking-widest"
            >
            ...
            <header className="mb-10">
              <h1 className="text-4xl md:text-5xl xl:text-[3.4rem] font-black text-white mb-6 leading-[1.08] tracking-tighter">
                {nota.titulo}
              </h1>
            ...
            --------------------------------------------------------- */}
            {imageUrl && (
              <figure className="mb-10 relative w-full xl:w-[88%] 2xl:w-[82%] rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl mx-auto">
            ...
            {nota.resumen && (
              <div className="relative mb-12 p-8 rounded-3xl bg-primary/5 border border-primary/20">
                ...
                <div className="absolute top-0 left-8 -translate-y-1/2 bg-primary text-slate-200 text-[10px] font-black px-3 py-1 rounded-full uppercase">
                  Resumen
                </div>

                <p className="text-xl md:text-2xl text-slate-200 leading-relaxed italic">
                  "{nota.resumen}"
                </p>
      ...
      [&_h2_strong]:text-white
              ...
              {/* =====================================================
                  CONTENIDO POSTERIOR A LA NOTICIA
              ====================================================== */}
